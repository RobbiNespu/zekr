...
public class NanoHttpd {
	 ...
	 */
	public static final String HEADER_REQUEST_ADDRESS = "X-Request-Socket-Address";
		...
		public void run() {
			try {
				...
				if (st.hasMoreTokens()) {
					...
					header.put(HEADER_REQUEST_ADDRESS, mySocket.getInetAddress().getHostAddress());
				}
	...
	/**
	 * Function test method. To be removed.
	 * 
	 * @param args
	 */

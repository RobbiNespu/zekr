...
CLASS_PATH=lib/log4j-1.2.8.jar:lib/swt-3.3.0.jar:lib/apache-commons.jar:lib/velocity-1.4.jar:lib/lucene-highlighter-2.2.0.jar:lib/lucene-core-2.2.0.jar:dist/zekr.jar

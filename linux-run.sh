...
CLASS_PATH=lib/log4j-1.2.8.jar:lib/swt-linux.jar:lib/apache-commons.jar:lib/velocity-1.4.jar:lib/lucene-highlighter-2.1.0.jar:lib/lucene-core-2.1.1-dev.jar:dist/zekr.jar
